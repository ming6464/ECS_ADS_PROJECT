...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	BlobAssetReference<ControllerBlob> BuildControllerBlob(AnimatorController controller)
	{
		...
		//	Try cache first
		var controllerBlob = BlobCache.LoadBakedControllerFromCache(controller);
		if (controllerBlob != BlobAssetReference<ControllerBlob>.Null)
			return controllerBlob;
		
		//	Try blob asset store
		var isControllerAlreadyBaked = TryGetBlobAssetReference(controllerHash, out controllerBlob);
