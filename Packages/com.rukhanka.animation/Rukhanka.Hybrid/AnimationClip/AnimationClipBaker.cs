...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	FixedStringName ConstructBoneClipName(ValueTuple<string, string> nameAndPath)
	{
		FixedStringName rv;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int GetOrCreateBoneClipHolder(ref NativeList<RTP.BoneClip> clipsArr, in FixedStringName name, BindingType bt)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int BuildAnimationBakeList(IBaker baker, AnimationClip[] animationClips, Avatar avatar, out NativeArray<BlobAssetReference<AnimationClipBlob>> alreadyBakedList)
	{
		...
		for (var i = 0; i < animationClips.Length; ++i)
		{
			...
			var acb = BlobCache.LoadBakedAnimationFromCache(ac, avatar);
			if (acb == BlobAssetReference<AnimationClipBlob>.Null)
			{
				//	Check for blob asset store
				var animationHash = BakingUtils.ComputeAnimationHash(ac, avatar);
				var isAnimationExists = baker.TryGetBlobAssetReference(animationHash, out acb);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public BlobAssetReference<AnimationClipBlob> CreateAnimationBlobAsset(AnimationClip ac, Animator animator, Hash128 animationHash)
	{
		...
		foreach (var b in bindings)
		{
			...
			var curveHolder = isGenericCurve ? genericCurvesArr : boneCurvesArr;
