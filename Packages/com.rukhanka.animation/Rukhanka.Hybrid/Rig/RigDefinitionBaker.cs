...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public override void Bake(RigDefinitionAuthoring a)
	{
		...
		GatherAnimatedRenderers(e, a);	
	}

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	void GatherAnimatedRenderers(Entity e, RigDefinitionAuthoring a)
	{
		//	Gather all related renderers and mark them. Will be used for animation culling purposes in runtime
		var rrs = a.GetComponentsInChildren<Renderer>();
		if (rrs.Length > 0)
		{
			var rb = AddBuffer<AnimatedRendererBakingComponent>(e);
			foreach (var r in rrs)
			{
				var needUpdateRenderBounds = (r as SkinnedMeshRenderer)?.updateWhenOffscreen;
				
				var c = new AnimatedRendererBakingComponent()
				{
					renderEntity = GetEntity(r, TransformUsageFlags.None),
					needUpdateRenderBounds = needUpdateRenderBounds.HasValue && needUpdateRenderBounds.Value
				};
				rb.Add(c);
			}
		}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	BlobAssetReference<RigDefinitionBlob> CreateRigBlob(Avatar avatar, RigDefinitionAuthoring rigDef, List<InternalSkeletonBone> skeletonBones, Hash128 rigHash)
	{
		...
		for (int i = 0; i < skeletonBones.Count; ++i)
		{
			...
			CreateRigBoneBlob(bb, ref boneBlob, rigDef, avatar, skeletonBones, i);
		}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void CreateRigBoneBlob(BlobBuilder bb, ref RigBoneInfo rbi, RigDefinitionAuthoring rda, Avatar avatar, List<InternalSkeletonBone> skeletonBones, int boneIndex)
	{
		var boneIsObjectRoot = boneIndex == 0;
		var skeletonBone = skeletonBones[boneIndex];
		var t = boneIsObjectRoot ? rda.transform : TransformUtils.FindChildRecursively(rda.transform, skeletonBone.name);
