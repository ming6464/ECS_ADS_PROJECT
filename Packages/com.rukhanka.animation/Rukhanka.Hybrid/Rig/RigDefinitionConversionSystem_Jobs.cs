...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void Execute(Entity e, [ChunkIndexInQuery] int chinkIndex, ref RigDefinitionComponent rdc, DynamicBuffer<BoneEntityRef> boneEntityRefs)
		{
			for (int l = 0; l < boneEntityRefs.Length; ++l)
			{
				...
				if (boneEntity != Entity.Null && !bakingOnlyLookup.HasComponent(boneEntity))
				{
					...
					ecb.AddComponent(chinkIndex, boneEntity, animatorEntityRefComponent);
				}
			}
		}
	}
