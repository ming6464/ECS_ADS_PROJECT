...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void AnimationsPostSetup(Span<AnimationToProcessComponent> animations, ref LayerBlob lb, int layerIndex, float weightMultiplier, float layerWeight)
	{
		...
		for (int k = 0; k < animations.Length; ++k)
		{
			...
			avatarMaskDatabase.TryGetValue(lb.avatarMaskBlobHash, out a.avatarMask);
			animations[k] = a;
		}
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		animationDatabase.TryGetValue(controllerAnimationsBlob.Value.animations[mb.animationIndex], out atp.animation);
		atp.weight = weight;
