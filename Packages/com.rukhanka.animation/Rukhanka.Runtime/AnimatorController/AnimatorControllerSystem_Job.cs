...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static void HandleCentroidCase(ref NativeList<MotionIndexAndWeight> rv, float2 pt, ref BlobArray<ChildMotionBlob> mbArr)
	{
		if (math.any(pt))
			return;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static NativeList<MotionIndexAndWeight> GetBlendTree2DSimpleDirectionalCurrentMotions(ref MotionBlob mb, in NativeArray<AnimatorControllerParameterComponent> runtimeParams)
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		case MotionBlob.Type.AnimationClip:
			animationDatabase.TryGetValue(controllerAnimationsBlob.Value.animations[mb.animationIndex], out var animBlob);
